...
public class Problem2 extends BaseClass {
    ...
    private static void sumValues(double[] arr, int arrayNumber) {
        ...
        //1st step add all arr values and print it out
        //2nd step print the total value of arr
        //3rd step have the total sum represented in 2 decimal places


        Object modifiedTotal = formated;
    ...
    public static void main(String[] args) {
        final String ucid = "muk"; // <-- change to your UCID
