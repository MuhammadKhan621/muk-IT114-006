...
public class Problem4 extends BaseClass {
    ...
    private static void transformText(String[] arr, int arrayNumber) {
        ...
        for(int i = 0; i <arr.length; i++){
            ...
            // UpperCase method is used to convert the text inside arr
            for(int b = 0; b < placeholderForModifiedPhrase.length(); b++){
            
            }

            //using replaceAll method to remove unnecessary space 
